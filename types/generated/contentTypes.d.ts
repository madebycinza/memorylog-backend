...
export interface ApiAlbumAlbum extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DisplayDate: Schema.Attribute.String;
    FeatOrder: Schema.Attribute.String;
    ...
    PublicationDate: Schema.Attribute.DateTime &
      Schema.Attribute.DefaultTo<'2024-11-16T09:15:00.000Z'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPlacePlace extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Country: Schema.Attribute.Enumeration<['Brazil', 'United States']> &
